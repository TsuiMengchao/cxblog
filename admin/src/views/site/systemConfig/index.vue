...
<!--      </el-tab-pane>-->
      ...
      <!--        <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="120px" :rules="rules"-->
      <!--          ref="form">-->
      <!--          <aside>-->
      ...
      <!--            <el-input v-model="form.emailHost" auto-complete="new-password" style="width: 400px"></el-input>-->
      <!--          </el-form-item>-->

      <!--          <el-form-item label="邮箱发送者">-->
      <!--            <el-input v-model="form.emailUsername" auto-complete="new-password" style="width: 400px"></el-input>-->
      <!--          </el-form-item>-->

      <!--          <el-form-item label="邮箱授权码">-->
      <!--            <el-input type="emailUsername" v-model="form.emailPassword" auto-complete="new-password"-->
...
<script>
import { getSystemConfig, updateSystemConfig } from '@/api/site/systemConfig'
