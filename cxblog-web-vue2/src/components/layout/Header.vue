        ...
        <nav>
            <div class="logo">
                <div class="logoBox">
                    <router-link :to="'/'">
                        ...
                        <span class="name">{{ $t('webName') }}</span>
                    </router-link>
            ...
            <ul class="starlist">
                <li :class="path == '/' ? 'active' : ''">
                    <span>
                        <router-link :to="'/'">
                            <svg-icon icon-class="home"></svg-icon> {{ $t('components.layout.header.home') }}
                        </router-link>
                    </span>
                </li>
                ...
                <li :class="path == '/archive' || path == '/categorys' || path == '/tag'
                    ...
                    <el-dropdown trigger="hover">
                        <span class="el-dropdown-link">
                            <svg-icon icon-class="archive"></svg-icon> {{ $t('components.layout.header.articleArchive') }}<i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <router-link style="text-decoration: none;color: #71777c;" :to="'/archive'">
                                <el-dropdown-item>
                                    <i class="el-icon-date"></i>{{ $t('components.layout.header.articleArchive') }}
                                </el-dropdown-item>
                            </router-link>
                            <router-link style="text-decoration: none;color: #71777c;" :to="'/categorys'">
                                <el-dropdown-item>
                                    <i class="el-icon-menu"></i>{{ $t('components.layout.header.articleCategory') }}
                                </el-dropdown-item>
                            </router-link>

                            <router-link style="text-decoration: none;color: #71777c;" :to="'/tag'">
                                <el-dropdown-item>
                                    <i class="el-icon-collection-tag"></i>{{ $t('components.layout.header.articleTag') }}
                                </el-dropdown-item>
                            </router-link>
                        </el-dropdown-menu>
                    </el-dropdown>
              ...
              <li :class="path == '/forum' || path == '/say' || path == '/tipsoon' || path == '/message'
                ...
                <el-dropdown trigger="hover">
                        <span class="el-dropdown-link">
                            <svg-icon icon-class="talk"></svg-icon> {{ $t('components.layout.header.moment') }}<i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                  <el-dropdown-menu slot="dropdown">
                    <router-link style="text-decoration: none;color: #71777c;" :to="'/forum'">
                      <el-dropdown-item>
                        <i class="el-icon-menu"></i>{{ $t('components.layout.header.forum') }}
                      </el-dropdown-item>
                    </router-link>
                    <router-link style="text-decoration: none;color: #71777c;" :to="'/say'">
                      <el-dropdown-item>
                ...
                <li>
                    <span>
                        <router-link :to="'/sponsor'" style="color:red;font-weight:700">
                            <svg-icon icon-class="sponsor"></svg-icon> {{ $t('components.layout.header.sponsor') }}
                        </router-link>
                    </span>
                </li>
                ...
                <li :class="path == '/navigation' ? 'active' : ''">
                    <span>
                        <router-link :to="'/navigation'">
                            <svg-icon icon-class="navication"></svg-icon> {{ $t('components.layout.header.navigation') }}
                        </router-link>
                    </span>
                </li>
                ...
                <li :class="path == '/links' ? 'active' : ''">
                    <span>
                        <router-link :to="'/links'">
                            <svg-icon icon-class="friendLink"></svg-icon> {{ $t('components.layout.header.friendLink') }}
                        </router-link>
                    </span>
                </li>
                <li :class="path == '/about' ? 'active' : ''">
                    <el-dropdown trigger="hover">
                        <span class="el-dropdown-link">
                            <svg-icon icon-class="about"></svg-icon> {{ $t('components.layout.header.about') }}<i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">

                            <router-link style="text-decoration: none;color: #71777c;" :to="'/about'">
                                <el-dropdown-item>
                                    <i class="el-icon-monitor"></i>{{ $t('components.layout.header.about') }}
                                </el-dropdown-item>
                            </router-link>
                            ...
                            <a style="text-decoration: none;color: #71777c;" href="https://gitee.com/Tsuimengchao/"
                                target="_blank">
                                <el-dropdown-item>
                                    <i class="iconfont icon-code"></i>{{ $t('components.layout.header.sourceCode') }}
                                </el-dropdown-item>
                            </a>
                ...
                <el-dropdown trigger="hover">
                    <span class="el-dropdown-link">
                        <button type="button" class="sendBtn">
                            <i class="el-icon-edit-outline"></i> {{ $t('components.layout.header.compose') }}
                        </button>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <router-link style="text-decoration: none;color: #71777c;" :to="'/newposts'">
                            <el-dropdown-item>
                                <svg-icon icon-class="article"
                                    style="width: 20px;height: 20px;vertical-align: -5px;"></svg-icon> {{ $t('components.layout.header.publishArticle') }}
                            </el-dropdown-item>
                        </router-link>
                        <router-link style="text-decoration: none;color: #71777c;" :to="'/newSays'">
                            <el-dropdown-item>
                                <svg-icon icon-class="say"
                                    style="width: 20px;height: 20px;vertical-align: -5px;"></svg-icon> {{ $t('components.layout.header.publishSay') }}
                            </el-dropdown-item>
                        </router-link>
                        ...
                        <router-link style="text-decoration: none;color: #71777c;" :to="'/forum'">
                            <el-dropdown-item>
                                <svg-icon icon-class="talk"
                                    style="width: 20px;height: 20px;vertical-align: -5px;"></svg-icon> {{ $t('components.layout.header.publishForum') }}
                            </el-dropdown-item>
                        </router-link>
                    </el-dropdown-menu>
                </el-dropdown>
            ...
            <el-dropdown @command="handleSetLanguage">
              <button class="sendBtn">
                <i class="el-icon-setting"></i>{{$t('components.layout.header.language')}}
              </button>
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item
                ...
                <el-dropdown trigger="hover">
                    ...
                    <el-dropdown-menu slot="dropdown" v-if="userInfo">
                        <router-link style="text-decoration: none;color: #71777c;" :to="'/user'">
                            <el-dropdown-item>
                              {{ $t('components.layout.header.userCenter') }}
                            </el-dropdown-item>
                        </router-link>
                        <a style="text-decoration: none;color: #71777c;" @click="logout">
                            <el-dropdown-item>{{$t('components.layout.header.logout')}}</el-dropdown-item>
                        </a>
                    </el-dropdown-menu>

                    <el-dropdown-menu slot="dropdown" v-else>
                        <div class="loginTip" style="padding: 10px;font-size: 0.9rem;">
                            <p>{{ $t('components.layout.header.loginTips')[0] }}</p>
                            <div style="margin-top: 10px;">
                                <span>
                                    <i class="el-icon-cloudy"></i> {{ $t('components.layout.header.loginTips')[1] }}
                                </span>

                                <span style="margin-left: 10px;">
                                    <i class="el-icon-cloudy"></i> {{ $t('components.layout.header.loginTips')[2] }}
                                </span>
                            </div>
                            <el-button @click="handleLogin()" style="margin:  0 auto;display: block;margin-top: 10px;"
                                type="success" size="small">{{ $t('components.layout.header.login') }}</el-button>
                        </div>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
