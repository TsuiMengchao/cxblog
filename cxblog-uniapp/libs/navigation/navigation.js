    ...
    },
    {
      ...
      list: [{
        ...
        },
        {
          icon: 'code',
          title: '广告页',
          url: '/momentPages/advertise',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '资讯详情',
          url: '/momentPages/news',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '名片王者',
          url: '/momentPages/resume',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '智能名片',
          url: '/momentPages/business',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '精选圈子',
          url: '/momentPages/talk',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '积分排行',
          url: '/momentPages/ranking',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '圈子详情',
          url: '/momentPages/forumDetails',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '预约接龙',
          url: '/momentPages/reserve',
          author: '图鸟北北'
        },
        {
          icon: 'code',
        ...
        },
        {
          icon: 'code',
          title: '一起群聊',
          url: '/momentPages/chat',
          author: '图鸟北北'
        },
        {
          icon: 'code',
          title: '对话聊天',
          url: '/momentPages/chatting',
          author: '图鸟北北'
        }
      ]
    },
