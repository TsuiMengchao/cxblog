    ...
    <view class="tn-safe-area-inset-bottom" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">想说点什么就说点什么吧</view>
        </view>
      ...
      <view class="tn-margin tn-bg-gray--light tn-padding" style="border-radius: 10rpx;">
        <textarea v-model="form.content" maxlength="500" placeholder="说点什么 , 万一火了呢"
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">发点什么图就发点什么图吧</view>
        </view>
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">地点</view>
        </view>
        <view class="tn-bg-gray--light">
          <tn-input v-model="form.address" name="input" placeholder-style="color:#AAAAAA"></tn-input>
        </view>
      </view>
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">是否公开</view>
        </view>
        <view class="justify-content-item tn-text-df tn-color-grey">
          <tn-switch v-model="form.public"></tn-switch>
        </view>
      </view>
    ...
    mixins: [page_mixin],
      ...
      submit() {
        ...
        this.$refs.imageUpload.lists.forEach((item)=>{
          this.form.imgUrl += item.data.response.data + ","
        })
        this.form.isPublic = this.form.public? '1':'0'
        insertSay(this.form).then(res => {
          this.$tn.message.toast("发布说说成功");
