...
<script>
  ...
  import {addForum} from "@/api/talk";
    ...
    mixins: [page_mixin],
		data() {
			return {
				action: 'https://server.cxblog.zhaohaoyue.love/api/file/upload?path=file.img.upload.forum',
        // action: 'http://127.0.0.1:8000/api/file/upload?path=file.img.upload.forum',
        selectShow: false,
				formData: {
          content: "",
          site: {url: "",
