  ...
  <div class="app-container">
    ...
    <el-form v-show="showSearch" ref="form" :inline="true" :model="params" label-width="68px">
      <el-form-item label="友链名称">
        <el-input v-model="params.name" style="width: 200px" size="small" placeholder="请输入友链名" />
      </el-form-item>
      <el-form-item label="友链状态">
        <el-select v-model="params.status" size="small" clearable placeholder="友链状态" @change="handleFind">
    ...
    <el-dialog center :title="title" :visible.sync="dialogFormVisible">
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item v-if="form.status === 0" label="下架原因" :label-width="formLabelWidth" prop="reason">
          <el-input v-model="form.reason" auto-complete="off" />
        </el-form-item>
...
<script>
import { fetchList, update, create, remove, top } from '@/api/site/friendLink'
