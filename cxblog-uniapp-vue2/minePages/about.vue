<template>
  <view class="template-about">
    ...
    <view class="container about-bg" v-html="aboutMe"></view>

    <button class='' open-type="contact" @click="tn('/minePages/resume')">
...
<script>
  ...
  export default {
    ...
    onLoad() {
	  this.aboutMe = uni.getStorageSync("webSiteInfo").aboutMe
	  this.getSystemInfo()
    },
    onReady() {
      this.$nextTick(() => {
