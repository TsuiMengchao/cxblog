<template>
	<view class="u-skeleton">
		...
		<image class="head-bg u-skeleton-rect" src="http://xy.tujingzg.com/api/post/detail?id=/uploads/postImages/20211130/2d7d4d646dd2043563fd2e068dd02cbf.png"></image>
		<view class="con-c">
			<view class="user-info">
				<!-- <image class="avatar" :src="userInfo.avatar"></image> -->
				<u-avatar class="avatar" :src="userInfo.avatar" :show-level="userInfo.type == 1" level-bg-color="#8072f3" size="130"></u-avatar>
				<view class="user-c">
					...
					<view style="display: flex;" class="btn-box u-skeleton-fillet">
			...
			<view v-show="current === 0">
				...
				<view class="f-wrap u-skeleton-fillet">
					...
					<view class="info-c">
						...
						<text v-if="userInfo.age === false">年龄：未知</text>
						<text v-else>年龄：{{ userInfo.age }}岁</text>
