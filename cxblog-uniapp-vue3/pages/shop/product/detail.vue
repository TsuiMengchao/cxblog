<template>
	<view>
		<u-swiper :height="sysInfo.screenWidth * 2" mode="number" indicator-pos="bottomRight" :border-radius="0" img-mode="aspectFill" :list="goodsInfo.album"></u-swiper>
		...
		<!-- 商品详情 -->
		<view class="goods-detail"><rich-text :nodes="goodsInfo.detail | formatRichText"></rich-text></view>
