<template>
	<view>
		...
		<view style="margin: 20rpx;padding: 20rpx;background-color: #fff;border-radius: 30rpx;">
			<view style="color:#19BE6B">请输入您要充值的金额</view>
		...
		<view style="margin: 20rpx;padding: 20rpx;background-color: #fff;border-radius: 30rpx;">
			<view style="color:#19BE6B">音叶记录</view>
			<u-table>
					<u-tr>
						<u-th>音叶记录</u-th>
						<u-th>音叶</u-th>
		...
		<view v-show="current === 1">
			<view style="margin: 20rpx;padding: 20rpx;background-color: #fff;border-radius: 30rpx;">
				<view style="color:#19BE6B">请输入您要提现的音叶数</view>
			...
			<view style="margin: 20rpx;padding: 20rpx;background-color: #fff;border-radius: 30rpx;">
				<view style="color:#19BE6B">提现记录</view>
				<u-table>
						<u-tr>
							<u-th>提现音叶</u-th>
							<u-th>金额</u-th>
