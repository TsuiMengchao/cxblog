<template>
    <el-card class="box box-shadow">
        ...
        <img src="/assets/img/site/beijing.jpg" alt="">
        <div class="user">

            <div class="avatar_wrapper">
                <img :src="$store.state.webSiteInfo.authorAvatar" alt="" class="userAvatar">
                <img class="guajian" src="/assets/img/site/gaoda.png" alt="">
            </div>
            <a class="username">
            ...
            <div class="lianxi">
                ...
                <a class="weibo" href="https://weibo.com/u/7450094325" target="_blank" title="微博"
                    rel="noopener noreferrer nofollow">
                    <svg-icon icon-class="weibo" />
                </a>
                <a class="zhihu" href="https://www.zhihu.com/people/meng-chen-xue-36" target="_blank" title="知乎"
                    rel="noopener noreferrer nofollow">
