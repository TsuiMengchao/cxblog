...
) ENGINE = InnoDB AUTO_INCREMENT = 917 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of blog_article_tag
-- ----------------------------
INSERT INTO `blog_article_tag` VALUES (915, 14, 10);
INSERT INTO `blog_article_tag` VALUES (916, 14, 65);
INSERT INTO `blog_article_tag` VALUES (913, 15, 10);
INSERT INTO `blog_article_tag` VALUES (914, 15, 64);
...
INSERT INTO `blog_im_message` VALUES ('35615057b1899358d3fd4558edc2bd8d', '4', '4', NULL, '恭喜您签到成功', NULL, '未知', '39.144.220.199', 0, 0, NULL, 5, NULL, 0, NULL, NULL);
...
INSERT INTO `blog_im_message` VALUES ('b7d9e1dab8564ba585060201133b01f1', '1', '4', NULL, 'test', NULL, '未知', '39.144.220.199', 0, 0, NULL, 5, 14, 1, 2, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3998 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
  ...
  UNIQUE INDEX `uniq_name`(`name`) USING BTREE,
  INDEX `inx_pid`(`pid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '系统菜单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  INDEX `inx_enabled`(`enabled`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '系统用户' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '梦辰雪', '男', '', 'tsuimengchao@163.com', 'cmc.png', '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', b'0', NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31', 1, 1, '127.0.0.1', '未知', 'Windows 10', '2023-12-07 17:32:08', 'Chrome 11', NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (2, 2, 'test', '测试用户', '男', '15600618521', 'tsuimengchao@qq.com', NULL, NULL, '$2a$10$4XcyudOYTSz6fue6KFNMHeUQnCX5jbBQypLEnGk1PmekXt5c95JcK', b'0', b'1', 'admin', 'admin', NULL, '2020-05-05 11:15:49', '2020-09-05 10:43:38', 1, 2, '192.168.0.177', '未知', 'Windows 10', '2023-12-01 21:37:30', 'Chrome 11', NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (3, 5, 'common', '普通用户', '男', '15600168521', 'tsuimengchao@foxmail.com', NULL, NULL, '$2a$10$QN4tYvXkX2ZOIjRoYnSQEe.4/vR4eTevMwJZ0Eok0cl8uuYxaU5bK', b'0', b'1', 'admin', 'admin', NULL, '2020-05-05 11:15:49', '2020-09-05 10:43:38', 1, 3, NULL, NULL, NULL, '2024-01-25 21:17:20', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (4, 18, 'tsuimengchao', '崔梦超', '男', '18333191029', 'tsuimengchao@aliyun.com', 'cmc.png', NULL, '$2a$10$geSY48NRbQleWKqJ/R7ae.JjuEx4LjdOPD75omh3UgWVwsBVwwsA6', b'0', b'1', 'System', 'System', '2024-01-30 13:10:46', '2024-01-30 11:58:28', '2024-02-29 18:17:44', 1, 4, '123.147.246.181', '未知', NULL, '2024-02-29 18:17:44', NULL, 'EE5F91C7CD66BC0BC12E94947E276D80', NULL, '7726769', NULL);
INSERT INTO `sys_user` VALUES (5, 18, 'zhy', '赵浩悦', '女', '15176907852', '2490739669@qq.com', NULL, NULL, '$2a$10$jGXMDgNC9Cj1pDflaVlycuQbEhNyJeER4rbrNiShKV.MJideJ5/.6', b'0', b'1', 'System', 'System', NULL, '2024-01-30 21:59:15', '2024-01-30 21:59:15', 1, 5, NULL, NULL, NULL, '2024-01-30 21:59:14', NULL, NULL, NULL, NULL, NULL);
