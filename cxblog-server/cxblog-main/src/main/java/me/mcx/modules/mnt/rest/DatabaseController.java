...
import me.mcx.modules.mnt.domain.Database;
import me.mcx.modules.mnt.service.DatabaseService;
import me.mcx.modules.mnt.domain.vo.DatabaseQueryCriteria;
import me.mcx.modules.mnt.util.SqlUtils;
...
public class DatabaseController {
	...
	@PreAuthorize("@cx.check('database:list')")
    ...
    @PostMapping
	@PreAuthorize("@cx.check('database:add')")
    ...
    @PutMapping
	@PreAuthorize("@cx.check('database:edit')")
    ...
    @DeleteMapping
	@PreAuthorize("@cx.check('database:del')")
	...
	@PreAuthorize("@cx.check('database:testConnect')")
