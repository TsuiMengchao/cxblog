	          ...
	          <view class="tn-flex tn-flex-col-center tn-flex-row-left">
	            <view class="logo-pic">
	              <view class="logo-image">
					...
					<view v-else class="tn-shadow-blur" style="background-image:url(http://七牛云.辰雪博客.赵浩悦.我爱你/9cf1222617fd4fa197991476a53cc883.jpg);width: 110rpx;height: 110rpx;background-size: cover;">
					</view>
	              </view>
	            </view>
