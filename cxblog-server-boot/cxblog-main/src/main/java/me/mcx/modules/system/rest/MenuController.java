...
public class MenuController {
    ...
    @PreAuthorize("@cx.check('menu:list')")
    ...
    @PreAuthorize("@cx.check('menu:list','roles:list')")
    ...
    @ApiOperation("新增菜单")
    @PostMapping
    @PreAuthorize("@cx.check('menu:add')")
    ...
    @ApiOperation("修改菜单")
    @PutMapping
    @PreAuthorize("@cx.check('menu:edit')")
    ...
    @ApiOperation("删除菜单")
    @DeleteMapping
    @PreAuthorize("@cx.check('menu:del')")
