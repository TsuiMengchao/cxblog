...
public class RoleController {
    ...
    @GetMapping(value = "/{id}")
    @PreAuthorize("@cx.check('roles:list')")
    ...
    @PreAuthorize("@cx.check('role:list')")
    ...
    @PreAuthorize("@cx.check('roles:list','user:add','user:edit')")
    ...
    @ApiOperation("新增角色")
    @PostMapping
    @PreAuthorize("@cx.check('roles:add')")
    ...
    @ApiOperation("修改角色")
    @PutMapping
    @PreAuthorize("@cx.check('roles:edit')")
    ...
    @ApiOperation("删除角色")
    @DeleteMapping
    @PreAuthorize("@cx.check('roles:del')")
