 ...
 */
package me.mcx.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    @ApiOperation("查询定时任务")
    @GetMapping
    @PreAuthorize("@cx.check('timing:list')")
    ...
    @ApiOperation("新增定时任务")
    @PostMapping
    @PreAuthorize("@cx.check('timing:add')")
    ...
    @ApiOperation("修改定时任务")
    @PutMapping
    @PreAuthorize("@cx.check('timing:edit')")
    ...
    @ApiOperation("删除定时任务")
    @DeleteMapping
    @PreAuthorize("@cx.check('timing:del')")
