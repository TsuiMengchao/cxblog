...
public class ServerController {
    ...
    @PreAuthorize("@cx.check('serverDeploy:list')")
    ...
    @PostMapping
	@PreAuthorize("@cx.check('serverDeploy:add')")
    ...
    @PutMapping
	@PreAuthorize("@cx.check('serverDeploy:edit')")
	...
	@DeleteMapping
	@PreAuthorize("@cx.check('serverDeploy:del')")
