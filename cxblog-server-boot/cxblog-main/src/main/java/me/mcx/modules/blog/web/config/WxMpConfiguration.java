package me.mcx.modules.blog.web.config;

import me.mcx.modules.blog.web.handle.*;
...
public class WxMpConfiguration {
    ...
    public WxMpDefaultConfigImpl wxMpConfigStorage() {
        ...
        final WxMpProperties.MpConfig config = this.properties.getConfig();
        if (config == null) {
    ...
    @Bean
    public WxMpService wxMpService(WxMpDefaultConfigImpl configStorage) {
