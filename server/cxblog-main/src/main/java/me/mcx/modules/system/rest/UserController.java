...
import me.mcx.modules.system.service.DataService;
import me.mcx.modules.system.domain.User;
import me.mcx.exception.BadRequestException;
import me.mcx.modules.system.domain.vo.UserPassVo;
...
import me.mcx.modules.system.service.VerifyService;
import me.mcx.utils.*;
import me.mcx.modules.system.service.UserService;
import me.mcx.utils.enums.CodeEnum;
...
public class UserController {
    ...
    @PreAuthorize("@cx.check('user:list')")
    ...
    @ApiOperation("新增用户")
    @PostMapping
    @PreAuthorize("@cx.check('user:add')")
    ...
    @ApiOperation("修改用户")
    @PutMapping
    @PreAuthorize("@cx.check('user:edit')")
    ...
    @ApiOperation("删除用户")
    @DeleteMapping
    @PreAuthorize("@cx.check('user:del')")
