...
public class ${className}Controller {
    ...
    @PreAuthorize("@cx.check('${changeClassName}:list')")
    ...
    @PreAuthorize("@cx.check('${changeClassName}:add')")
    ...
    @PreAuthorize("@cx.check('${changeClassName}:edit')")
    ...
    @PreAuthorize("@cx.check('${changeClassName}:del')")
