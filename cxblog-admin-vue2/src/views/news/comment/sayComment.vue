<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-if="checkPer(['admin','sayComment:deleteBatch'])"
    ...
    <div style="margin-top: 5px">
      <el-table border :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="articleTitle" align="center" width="250" label="所属说说" />
...
<script>
import { fetchComment, deleteBatch } from '@/api/news/sayComment'
...
export default {
  data() {
    return {
      ...
      permission: {
        del: ['admin', 'sayComment:deleteBatch']
      }
    }
  },
  created: function() {
